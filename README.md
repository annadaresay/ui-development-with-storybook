...
This template ships with the main Angular and Storybook configuration files you'll need to get up and running fast. Based on Chromatic's Intro to Storybook Angular template: https://www.chromatic.com/
